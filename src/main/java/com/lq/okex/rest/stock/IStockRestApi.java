package com.lq.okex.rest.stock;
...
public interface IStockRestApi {
	 ...
	 * @param price
	 *            下单价格 [限价买单(必填)： 大于等于0，小于等于1000000 | 市价买单(必填)： BTC
	 ...
	 *            买卖类型： 限价单（buy/sell） 市价单（buy_market/sell_market）
	 * @param orders_data
	 *            JSON类型的字符串 例：[{price:3,amount:5},{price:3,amount:3}]
