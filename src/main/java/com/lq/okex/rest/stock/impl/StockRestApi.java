package com.lq.okex.rest.stock.impl;
...
import com.lq.okex.rest.HttpUtilManager;
import com.lq.okex.rest.MD5Util;
import com.lq.okex.rest.StringUtil;
...
public class StockRestApi implements IStockRestApi {
	 ...
	 * 现货K线数据
	 */
	private final String KLINES_URL = "/api/v1/kline.do?";
	/**
	 * 现货获取用户信息URL
	 */
